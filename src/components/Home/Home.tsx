...
function Home() {
    ...
    <>
      <div className="flex flex-col items-center justify-center p-20">
        <div className="bg-secondary border-4 border-[#b88d5b] rounded-lg p-4 px-10 shadow-md w-[440px] font-serif inline-block">
          <h2 className="text-[2.2em] leading-[1.1] pb-10 pt-10">Adapte. Lute. Supere.</h2>
          <text>Em um futuro onde a tecnologia entrou em colapso e o mundo se tornou um campo de teste abandonado, 
